...
string message::collision_paddle_brick(size_t brick_index)
{
    return "Paddle superposed with brick " + to_string(brick_index) + "\n";
}

string message::collision_balls(size_t ball1_index, size_t ball2_index)
{
...
string message::collision_ball_brick(size_t ball_index, size_t brick_index)
{
    return "Ball " + to_string(ball_index) + " superposed with brick " +
           to_string(brick_index) + "\n";
}

string message::collision_paddle_ball(size_t ball_index)
{
